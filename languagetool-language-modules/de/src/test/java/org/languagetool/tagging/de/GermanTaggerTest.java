...
public class GermanTaggerTest {
  ...
  public void bugFixTemp() throws IOException{
    ...
    List<RuleMatch> matches = langTool.check("Beim Wiederaufbau wurde das original-gotische Achsfenster mit reichem Maßwerk ausgebaut und an die südliche Polygonweite gesetzt.");
